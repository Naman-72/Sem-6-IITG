...
int main()
{
    ...
    output_lbg = fopen("output_lbg.txt","w");
    // dataset input
    ...
    while (1)
    {
        ...
        // printf("Distortion : %lf \n",new_distortion);
        // printf("Avg Distortion : %lf \n",new_distortion/N);
        int noofiter = 1;

        while (abs(old_distortion-new_distortion)/new_distortion > 1e-3)
        {
            noofiter++;
    ...
    // for (int i = 0; i < N; i++)
    // {
    //     fprintf(output_lbg,"Point %d : (",i);
    //     for (int j = 0; j < M; j++)
    //     {
    //         if(j==M-1)
    //         {
    //             fprintf(output_lbg," %lf )",A[i][j]);
    //         }
    //         else
    //         {
    //             fprintf(output_lbg," %lf,",A[i][j]);

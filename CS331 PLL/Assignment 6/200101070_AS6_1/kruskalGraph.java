...
// LINKED LIST FOR NODE<SET<u,v,w>>
// IT WILL ADD IN SORTED MANNER
...
public class kruskalGraph {
    ...
    LinkedList[] A;
    // FOR STORING MINIMUM SPANNING TREE : Kgraph
    LinkedList[] Kgraph;
    // Testcase no
    int testcase;
    int V;
    ...
    // while adding node checking for cycle 
    ...
    {       
        ...
        // storing and printing all unique edges of graph
        try{
        ...
        while(n!=null)
        {
            // start from my set take every edge and add it
            Kgraph[n.u].push(n.v, n.w);
            Kgraph[n.v].push(n.u, n.w);
            if(checkcycle())
            {
                // if it makes cycle remove it and add in nonHighlighted (will be used for printing)
        ...
        // printing the colorful graph with mst as colored and rest non colored
        try{

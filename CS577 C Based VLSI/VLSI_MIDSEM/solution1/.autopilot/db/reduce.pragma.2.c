# 1 "dilithium3/reduce.c"
# 1 "dilithium3/reduce.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 4 "dilithium3/reduce.c" 2
# 15 "dilithium3/reduce.c"
int32_t pqcrystals_dilithium3_ref_montgomery_reduce(int64_t a) {
  int32_t t;
...
# 50 "dilithium3/reduce.c"
int32_t pqcrystals_dilithium3_ref_caddq(int32_t a) {
  a += (a >> 31) & 8380417;
  return a;
}
# 65 "dilithium3/reduce.c"
int32_t pqcrystals_dilithium3_ref_freeze(int32_t a) {

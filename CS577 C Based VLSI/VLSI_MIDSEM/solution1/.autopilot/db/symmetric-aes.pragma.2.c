# 1 "dilithium3/symmetric-aes.c"
# 1 "dilithium3/symmetric-aes.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "dilithium3/symmetric-aes.c" 2
...
# 2 "dilithium3/symmetric-aes.c" 2
...
void pqcrystals_dilithium3_ref_dilithium_shake256_stream_init(keccak_state *state,
                                    ...
                                    uint16_t nonce);
# 3 "dilithium3/symmetric-aes.c" 2
...
void pqcrystals_aes256ctr_ref_squeezeblocks(uint8_t *out,
                             size_t nblocks,
                             aes256ctr_ctx *state);
# 4 "dilithium3/symmetric-aes.c" 2

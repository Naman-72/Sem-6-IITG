# 1 "dilithium3/symmetric-shake.c"
# 1 "dilithium3/symmetric-shake.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "dilithium3/symmetric-shake.c" 2
...
# 2 "dilithium3/symmetric-shake.c" 2
...
# 3 "dilithium3/symmetric-shake.c" 2
...
void pqcrystals_dilithium3_ref_dilithium_shake256_stream_init(keccak_state *state,
                                    ...
                                    uint16_t nonce);
# 4 "dilithium3/symmetric-shake.c" 2

...
# 49 "dilithium3/ntt.c"
void pqcrystals_dilithium3_ref_ntt(int32_t a[256]) {_ssdm_SpecArrayDimSize(a, 256);
...
# 77 "dilithium3/ntt.c"
void pqcrystals_dilithium3_ref_invntt_tomont(int32_t a[256]) {_ssdm_SpecArrayDimSize(a, 256);

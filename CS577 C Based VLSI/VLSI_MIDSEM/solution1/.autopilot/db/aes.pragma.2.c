...
# 40 "dilithium3/aes.c" 2
# 1 "dilithium3/aes.h" 1
# 43 "dilithium3/aes.h"
struct AES_ctx
{
...
void Cipher(state_t* state2, uint8_t RoundKey[240])
{_ssdm_SpecArrayDimSize(RoundKey, 240);
  uint8_t round = 0;


  state_t state[1];
# 431 "dilithium3/aes.c"

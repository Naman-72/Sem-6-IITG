# 1 "dilithium3/PQCgenKAT_sign.c"
# 1 "dilithium3/PQCgenKAT_sign.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "dilithium3/PQCgenKAT_sign.c" 2
...
# 9 "dilithium3/PQCgenKAT_sign.c" 2
...
# 307 "D:/Xilinx/Vivado/2019.2/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\stdlib.h" 3
...
# 400 "D:/Xilinx/Vivado/2019.2/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\stdlib.h" 3
...
# 627 "D:/Xilinx/Vivado/2019.2/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\stdlib.h" 3
#pragma pack(pop)
...
# 205 "D:/Xilinx/Vivado/2019.2/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\malloc.h" 3
#pragma pack(pop)
# 630 "D:/Xilinx/Vivado/2019.2/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\stdlib.h" 2 3
# 10 "dilithium3/PQCgenKAT_sign.c" 2
...
# 11 "dilithium3/PQCgenKAT_sign.c" 2
# 1 "D:/Xilinx/Vivado/2019.2/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\ctype.h" 1 3
...
# 1 "D:/Xilinx/Vivado/2019.2/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\_mingw.h" 1 3
# 9 "D:/Xilinx/Vivado/2019.2/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\ctype.h" 2 3
# 36 "D:/Xilinx/Vivado/2019.2/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\ctype.h" 3
  extern unsigned short ** __imp__pctype;
# 51 "D:/Xilinx/Vivado/2019.2/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\ctype.h" 3
  extern unsigned short ** __imp__wctype;
# 63 "D:/Xilinx/Vivado/2019.2/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\ctype.h" 3
  extern unsigned short ** __imp__pwctype;
# 72 "D:/Xilinx/Vivado/2019.2/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\ctype.h" 3
...
# 100 "D:/Xilinx/Vivado/2019.2/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\ctype.h" 3
...
# 12 "dilithium3/PQCgenKAT_sign.c" 2
# 1 "dilithium3/rng.h" 1
# 18 "dilithium3/rng.h"
typedef struct {
...
# 13 "dilithium3/PQCgenKAT_sign.c" 2
# 1 "dilithium3/api.h" 1



# 1 "dilithium3/config.h" 1
# 5 "dilithium3/api.h" 2
# 23 "dilithium3/api.h"
int pqcrystals_dilithium3_ref_keypair(unsigned char *pk, unsigned char *sk);


int pqcrystals_dilithium3_ref(unsigned char *sm, unsigned long long *smlen,
                const unsigned char *msg, unsigned long long len,
                const unsigned char *sk);


int pqcrystals_dilithium3_ref_open(unsigned char *m, unsigned long long *mlen,
                     const unsigned char *sm, unsigned long long smlen,
                     const unsigned char *pk);
# 14 "dilithium3/PQCgenKAT_sign.c" 2
...
# 36 "dilithium3/PQCgenKAT_sign.c"
...
main()
{
    ...
    unsigned char m[3300], sm[3300+3293], m1[3300+3293];
    unsigned long long mlen, smlen, mlen1;
    int count;
    int done;
    unsigned char pk[1952], sk[4016];
    int ret_val;
    int i;


    sprintf(fn_req, "PQCsignKAT_%d.req", 4016);
    if ( (fp_req = fopen(fn_req, "w")) == ((void *)0) ) {
        printf("Couldn't open <%s> for write\n", fn_req);
        return -1;
    }
    sprintf(fn_rsp, "PQCsignKAT_%d.rsp", 4016);
    ...
    do {
        ...
        if ( (ret_val = pqcrystals_dilithium3_ref_keypair(pk, sk)) != 0) {
            printf("crypto_sign_keypair returned <%d>\n", ret_val);
            return -4;
        }
        fprintBstr(fp_rsp, "pk = ", pk, 1952);
        fprintBstr(fp_rsp, "sk = ", sk, 4016);

        if ( (ret_val = pqcrystals_dilithium3_ref(sm, &smlen, m, mlen, sk)) != 0) {
        ...
        if ( (ret_val = pqcrystals_dilithium3_ref_open(m1, &mlen1, sm, smlen, pk)) != 0) {
...
# 179 "dilithium3/PQCgenKAT_sign.c"
    fclose(fp_req);
    fclose(fp_rsp);

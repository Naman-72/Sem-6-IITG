...
static  char aesl_internal__OC_str15[11] = "Dilithium3";
...
signed int main(void) {
  ...
  static  unsigned long long aesl_llvm_cbe_sm_count = 0;
   char llvm_cbe_sm[6593];    /* Address-exposed local */
  static  unsigned long long aesl_llvm_cbe_m1_count = 0;
   char llvm_cbe_m1[6593];    /* Address-exposed local */
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = call i32 (i8*, i8*, ...)* @sprintf(i8* %%1, i8* getelementptr inbounds ([18 x i8]* @aesl_internal_.str, i64 0, i64 0), i32 4016) nounwind, !dbg !20 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_38_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = call i32 (i8*, i8*, ...)* @sprintf(i8* %%8, i8* getelementptr inbounds ([18 x i8]* @aesl_internal_.str3, i64 0, i64 0), i32 4016) nounwind, !dbg !22 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_62_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%46 = getelementptr inbounds [1952 x i8]* %%pk, i64 0, i64 0, !dbg !26 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_198_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%47 = getelementptr inbounds [4016 x i8]* %%sk, i64 0, i64 0, !dbg !26 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_199_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%48 = getelementptr inbounds [6593 x i8]* %%sm, i64 0, i64 0, !dbg !26 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_200_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%49 = getelementptr inbounds [6593 x i8]* %%m1, i64 0, i64 0, !dbg !26 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_201_count);
...
printf("\n = 0x%I64X\n", llvm_cbe_tmp__68);
if (AESL_DEBUG_TRACE)
printf("\n  %%93 = call i32 @pqcrystals_dilithium3_ref_open(i8* %%49, i64* %%mlen1, i8* %%48, i64 %%92, i8* %%46) nounwind, !dbg !26 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_307_count);
  llvm_cbe_tmp__69 = (unsigned int )pqcrystals_dilithium3_ref_open(( char *)llvm_cbe_tmp__43, (signed long long *)(&llvm_cbe_mlen1), ( char *)llvm_cbe_tmp__42, llvm_cbe_tmp__68, ( char *)llvm_cbe_tmp__40);
if (AESL_DEBUG_TRACE) {
...
llvm_cbe_tmp__94:
if (AESL_DEBUG_TRACE)
printf("\n  call void @fprintBstr(%%struct._iobuf* %%10, i8* getelementptr inbounds ([6 x i8]* @aesl_internal_.str24, i64 0, i64 0), i8* %%46, i64 1952), !dbg !23 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_266_count);
  fprintBstr((l_struct_OC__iobuf *)llvm_cbe_tmp__10, ( char *)((&aesl_internal__OC_str24[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 6
#endif
])), ( char *)llvm_cbe_tmp__40, 1952ull);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",1952ull);
}
if (AESL_DEBUG_TRACE)
printf("\n  call void @fprintBstr(%%struct._iobuf* %%10, i8* getelementptr inbounds ([6 x i8]* @aesl_internal_.str25, i64 0, i64 0), i8* %%47, i64 4016), !dbg !23 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_267_count);
  fprintBstr((l_struct_OC__iobuf *)llvm_cbe_tmp__10, ( char *)((&aesl_internal__OC_str25[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 6
#endif
])), ( char *)llvm_cbe_tmp__41, 4016ull);
if (AESL_DEBUG_TRACE) {
...
printf("\n = 0x%I64X\n", llvm_cbe_tmp__62);
if (AESL_DEBUG_TRACE)
printf("\n  %%84 = call i32 @pqcrystals_dilithium3_ref(i8* %%48, i64* %%smlen, i8* %%45, i64 %%83, i8* %%47) nounwind, !dbg !26 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_275_count);
  llvm_cbe_tmp__63 = (unsigned int )pqcrystals_dilithium3_ref(( char *)llvm_cbe_tmp__42, (signed long long *)(&llvm_cbe_smlen), ( char *)llvm_cbe_tmp__39, llvm_cbe_tmp__62, ( char *)llvm_cbe_tmp__41);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%78 = call i32 @pqcrystals_dilithium3_ref_keypair(i8* %%46, i8* %%47) nounwind, !dbg !26 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_257_count);
  llvm_cbe_tmp__60 = (unsigned int )pqcrystals_dilithium3_ref_keypair(( char *)llvm_cbe_tmp__40, ( char *)llvm_cbe_tmp__41);
if (AESL_DEBUG_TRACE) {
